...
def main():
    ...
    def normalize_title(t: str) -> str:
        t = t.lower()
        junk = ["exclusive", "breaking", "official", "the wrap", "variety",
                "deadline", "hollywood reporter", "indiewire", "report",
                "says", "reveals", "announces", "unveils", "first-look",
                "photo", "guest star", "season 3", "premiere", "to", "on",
                "in", "with", "for", "a", "the", "and", "of"]
        for w in junk:
            t = re.sub(rf"\b{w}\b", " ", t)
